...
JLLWrappers.@declare_library_product(libadios2_fortran, "@rpath/libadios2_fortran.2.dylib")
JLLWrappers.@declare_library_product(libadios2_fortran_mpi, "@rpath/libadios2_fortran_mpi.2.dylib")
JLLWrappers.@declare_library_product(libadios2_taustubs, "@rpath/libadios2_taustubs.dylib")
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libadios2_fortran,
        "lib/libadios2_fortran.2.7.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libadios2_fortran_mpi,
        "lib/libadios2_fortran_mpi.2.7.1.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )

    JLLWrappers.@init_library_product(
        libadios2_taustubs,
        "lib/libadios2_taustubs.dylib",
        RTLD_LAZY | RTLD_DEEPBIND,
    )
