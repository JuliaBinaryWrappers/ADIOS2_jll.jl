...
function __init__()
    JLLWrappers.@generate_init_header(Blosc2_jll, Bzip2_jll, CompilerSupportLibraries_jll, SZ_jll, ZeroMQ_jll, libpng_jll, zfp_jll, MPItrampoline_jll, MPIPreferences)
