...
function __init__()
    JLLWrappers.@generate_init_header(Blosc2_jll, Bzip2_jll, CompilerSupportLibraries_jll, ZeroMQ_jll, libpng_jll, pugixml_jll, yaml_cpp_jll, zfp_jll, MicrosoftMPI_jll, MPIPreferences)
