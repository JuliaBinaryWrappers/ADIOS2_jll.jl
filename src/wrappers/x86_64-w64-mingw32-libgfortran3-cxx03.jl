# Autogenerated wrapper script for ADIOS2_jll for x86_64-w64-mingw32-libgfortran3-cxx03
...
function __init__()
    JLLWrappers.@generate_init_header(Blosc_jll, Bzip2_jll, CompilerSupportLibraries_jll, MicrosoftMPI_jll, ZeroMQ_jll, libpng_jll, zfp_jll)
