# Autogenerated wrapper script for ADIOS2_jll for aarch64-apple-darwin-libgfortran5-mpi+mpitrampoline
...
function __init__()
    JLLWrappers.@generate_init_header(Blosc2_jll, Bzip2_jll, CompilerSupportLibraries_jll, HDF5_jll, SZ_jll, ZeroMQ_jll, libpng_jll, zfp_jll, MPItrampoline_jll, MPIPreferences)
